...
const WhatsAppWidget = () => {
    // Replace with your actual BeautyHaat WhatsApp Business number (include country code, omit + or 00)
    const phoneNumber = "8801805744174";
    const defaultMessage = encodeURIComponent("Hi BeautyHaat, I have a question about a product.");
