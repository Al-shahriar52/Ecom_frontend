        ...
        <header className="header-wrapper">
            ...
            <div className="header-main">
                ...
                <div className="header-right">
                    ...
                    <Link to="/wishlist" className="header-action-btn btn-wishlist">
                        {/!* Heart Icon *!/}
                       ...
                       {/!*<span className="wishlist-text">WISHLIST</span>*!/}
                        ...
                        {/!* Count Badge - Inline like Bag *!/}
                        {totalWishlistItems > 0 && (
                            <span className="wishlist-item-count">{totalWishlistItems}</span>
                        )}
                    </Link>
            ...
            {/!* ... Rest of your Header (Category Nav, Mega Menu, etc.) ... *!/}
...
const Header = () => {
    ...
    return (
        <header className="header-wrapper">
                ...
                <div className="sidenav-links">
                    ...
                    {loadingCategories ? (
                        Array.from({ length: 7 }).map((_, idx) => (
                            <div key={idx} className="sidenav-item skeleton-mobile-row">
            ...
            <nav className="category-nav desktop-only" onMouseLeave={handleCategoryMouseLeave}>
                {/* DESKTOP CATEGORY SKELETON LOADER */}
                {loadingCategories ? (
                    Array.from({ length: 8 }).map((_, idx) => (
                        <div key={idx} className="category-item-wrapper skeleton-nav-item">
                            <div className="skeleton-icon-circle"></div>
            ...
            {isBrandMenuOpen &&
                <div className="brands-mega-menu" onMouseEnter={handleBrandMouseEnter} onMouseLeave={handleBrandMouseLeave}>
                    {/* BRAND MENU SKELETON LOADER */}
                    {isLoadingBrands ? (
                        <div className="brands-mega-menu-content skeleton-brands-wrapper">
                            <div className="brands-menu-left">
                                <div className="brand-section">
                                    <div className="skeleton-title"></div>
                                    <ul>
                                        {Array.from({ length: 5 }).map((_, i) => <li key={i}><div className="skeleton-text-line"></div></li>)}
                                    </ul>
                                </div>
                            </div>
                            <div className="brands-menu-right">
                                <div className="top-brands-grid">
                                    ...
                                    <div className="logo-grid">
                                        {Array.from({ length: 6 }).map((_, i) => <div key={i} className="skeleton-logo-box"></div>)}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="brands-mega-menu-content">
                            ...
                            <div className="brands-menu-right">
                                <div className="alphabet-index">{alphabet.map(c => <a href={`#brand-group-${c}`} key={c}>{c}</a>)}</div>
                                <div className="top-brands-grid">
                                    <h4>TOP BRANDS</h4>
                                    <div className="logo-grid">
